...
+(NSString*) getAppInfo{
    NSString *str=@"";
    str=[NSString stringWithFormat:@"--------------------------------------------------------\n************************   App信息  ********************\n App名字:%@\n App包名:%@\n App版本号:%@ \n ipa包版本号:%@\n--------------------------------------------------------\n",[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleDisplayName"],[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleIdentifier"],[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"],[[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleVersion"]];
    return str;
}
+(NSString*) getDeviceInfo{
    ...
    float batteryLv = [[UIDevice currentDevice] batteryLevel];
    batteryLv=-1*batteryLv;
    str=[NSString stringWithFormat:@"\n************************   设备信息  ********************\n别名:  %@\n设备名称:%@\n系统版本:%@\n型号:  %@\n电量:  %f\n--------------------------------------------------------\n",userPhoneName,deviceName,phoneVersion,phoneModel,batteryLv];
    return str;
}
